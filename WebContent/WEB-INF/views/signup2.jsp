  ...
  <section id="hero" class="d-flex align-items-center">
	...
	<div class="col-sm-10 col-md-8 col-lg-6 mx-auto d-table h-100">
					<div class="card">
							<div class="card-body">
								<div class="m-sm-4">
									<form method="post" action="/codecompilance/user_creation">
                    <input type="hidden" name="_token" value="a8OS8A1IMADyZfMyrKuxiy0AUUQsKPQuUDFRtXga">
                    <div class="input-group mb-3">                    
                      <div class="input-group-prepend">
                        <label class="input-group-text" for="inputGroupSelect01">Choose a plan</label>
                      </div>
                      <select class="custom-select" id="inputGroupSelect01" name="inputUserType">
                        ...
                        <option value="premium" <c:if test="${plan == 'premium'}">selected</c:if>>Premium</option>
                        <option value="extra" <c:if test="${plan == 'extra'}">selected</c:if>>Extra</option>
                      </select>
                    </div>
										<div class="form-group">
											<label>Name *</label>
											<input class="form-control form-control-lg" type="text" name="name" placeholder="Name" maxlength = "20" required>
										</div>
										<div class="form-group">
											<label>Company *</label>
											<input class="form-control form-control-lg" type="text" name="company" placeholder="Company Name" maxlength = "50" required>
										</div>
										<div class="form-group">
											<label>Email *</label>
											<input class="form-control form-control-lg" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" type="email" name="email" placeholder="Email" maxlength = "50" required>
											<p><i>*This will be your username for login</i></p>
										</div>
										<div class="form-group">
											<label>Password *</label>
											<input id="txtPassword" class="form-control form-control-lg" type="password" name="password" placeholder="Password" minlength = "4" maxlength = "10" required>
										</div>
										<div class="form-group">
											<label>Confirm Password *</label>
											<input id="txtConfirmPassword" class="form-control form-control-lg" type="password" name="password" placeholder="Password" required>
										</div>
										<div class="text-center mt-3">
											<button type="submit" class="btn btn-lg get-started-btn" onclick="return Validate()">Sign up</button>
										</div>
									</form>
								</div>
							</div>
